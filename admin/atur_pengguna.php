          ...
          <tbody>
            <?php while ($admin = mysqli_fetch_assoc($admins)): ?>
              <tr>
                ...
                <td><img src="../assets/foto/<?php echo $admin['Photo']; ?>" alt="Admin Photo" class="img-thumbnail" style="width: 50px;"></td>
                <td>
                  <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editAdminModal<?php echo $admin['UserID']; ?>">
              ...
              <!-- Modal Edit Admin -->
              <div class="modal fade" id="editAdminModal<?php echo $admin['UserID']; ?>" tabindex="-1" aria-labelledby="editAdminModalLabel<?php echo $admin['UserID']; ?>" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                      <form action="edit_user.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                          <label for="adminName" class="form-label">Nama Admin</label>
                          <input type="text" class="form-control" id="adminName" name="adminName" value="<?php echo $admin['Nama']; ?>" required>
                        </div>
                        <div class="mb-3">
                          <label for="adminEmail" class="form-label">Email Admin</label>
                        ...
                        <div class="mb-3">
                          <label for="adminRole" class="form-label">Role</label>
                          <input type="text" class="form-control" id="adminRole" name="adminRole" value="<?php echo $admin['Role']; ?>" required>
                        </div>
                        <div class="mb-3">
                          <label for="adminPhoto" class="form-label">Foto Admin</label>
