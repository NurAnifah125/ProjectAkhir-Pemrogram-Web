...
<div class="main-content">
  <div class="container-fluid">
    <h2><i class="bi bi-journal-bookmark"></i> Manajemen Kuliner</h2>

    <!-- Tombol Tambah Trip -->
    <a href="tambah_kuliner.php" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Kuliner</a>
    <h4 class="pt-4"><i class="bi bi-journal-text"></i> Daftar Kuliner</h4>
    <!-- Tabel Daftar Trip -->
        ...
        <tbody>
          <?php while ($row = mysqli_fetch_assoc($result)): ?>
            <tr>
              ...
              <td>
                <a href="ubah_kuliner.php?id=<?php echo $row['ID']; ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                <a href="hapus_kuliner.php?id=<?php echo $row['ID']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin menghapus trip ini?');"><i class="fas fa-trash-alt"></i> Delete</a>
              </td>
            </tr>
          <?php endwhile; ?>
        </tbody>
